...
public class PublisherDAO extends BaseDAO{
	...
	public List<Publisher> getPublisherByName(String search) throws ClassNotFoundException, SQLException {
		search = "%"+search+"%";
		
		return readFirstLevel("select * from tbl_publisher where publisherName like ?", new Object[] {search});
	}
