...
public class BorrowerDAO extends BaseDAO{
	...
	public List<Borrower> getBorrowerByName(String search) throws ClassNotFoundException, SQLException {
		search = "%"+search+"%";
		
		return readFirstLevel("select * from tbl_borrower where name like ?", new Object[] {search});
	}
